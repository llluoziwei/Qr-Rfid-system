        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-item label="目录类型" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['kitName', validatorRules.kitName]" placeholder="请输入目录类型" disabled ></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-item label="出库时间" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-date placeholder="请选择出库时间" v-decorator="['outTime', validatorRules.outTime]" :trigger-change="true" :show-time="true" date-format="YYYY-MM-DD HH:mm:ss" style="width: 100%" disabled/>
            </a-form-item>
          </a-col>
