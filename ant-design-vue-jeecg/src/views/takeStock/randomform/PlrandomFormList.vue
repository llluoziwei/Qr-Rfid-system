<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('随机盈亏表')">导出</a-button>
    ...
    <plrandom-form-modal ref="modalForm" @ok="modalFormOk"></plrandom-form-modal>
  </a-card>
</template>
...
<script>
  ...
  import PlrandomFormModal from './modules2/PlrandomFormModal'
  import {filterMultiDictText} from '@/components/dict/JDictSelectUtil'

  export default {
    name: 'PlrandomFormList',
    ...
    data () {
      return {
        ...
        url: {
          list: "/plrandomForm/plrandomForm/list",
          delete: "/plrandomForm/plrandomForm/delete",
          deleteBatch: "/plrandomForm/plrandomForm/deleteBatch",
          exportXlsUrl: "/plrandomForm/plrandomForm/exportXls",
          importExcelUrl: "plrandomForm/plrandomForm/importExcel",
