package org.jeecg.modules.outrecord.controller;
...
import org.jeecg.modules.outrecord.entity.OutRecord;
import org.jeecg.modules.outrecord.service.IOutRecordService;
...
@Api(tags="出库记录")
@RestController
@RequestMapping("/outrecord/outRecord")
@Slf4j
public class OutRecordController extends JeecgController<OutRecord, IOutRecordService> {
    ...
    */
    ...
    public ModelAndView exportXls(HttpServletRequest request, OutRecord outRecord) {
        return super.exportXls(request, outRecord, OutRecord.class, "出库记录");
    }
