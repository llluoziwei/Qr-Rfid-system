        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-item label="入库时间" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-date placeholder="请选择入库时间" v-decorator="['enterTime']" :trigger-change="true" :show-time="true" date-format="YYYY-MM-DD HH:mm:ss" style="width: 100%" />
            </a-form-item>
          </a-col>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/enterrecord/enterRecord/add",
          edit: "/enterrecord/enterRecord/edit",
          queryById: "/enterrecord/enterRecord/queryById"
        }
      }
    },
    computed: {
