<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('随机盘点')">导出</a-button>
    ...
    <randomCheck-modal ref="modalForm" @ok="modalFormOk"></randomCheck-modal>
  </a-card>
</template>
...
<script>
  ...
  import RandomCheckModal from './modules/RandomCheckModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/randomcheck/randomCheck/rootList",
          childList: "/randomcheck/randomCheck/childList",
          getChildListBatch: "/randomcheck/randomCheck/getChildListBatch",
          delete: "/randomcheck/randomCheck/delete",
          deleteBatch: "/randomcheck/randomCheck/deleteBatch",
          exportXlsUrl: "/randomcheck/randomCheck/exportXls",
          importExcelUrl: "randomcheck/randomCheck/importExcel",
        },
        expandedRowKeys:[],
