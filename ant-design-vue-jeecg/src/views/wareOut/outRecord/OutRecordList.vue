<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('出库记录')">导出</a-button>
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        // list: "/outrecord/outRecord/list",
        list: '/wareout/wareOut/list',
        delete: '/outrecord/outRecord/delete',
        deleteBatch: '/outrecord/outRecord/deleteBatch',
        exportXlsUrl: '/outrecord/outRecord/exportXls',
        importExcelUrl: 'outrecord/outRecord/importExcel',
      },
      dictOptions: {},
      superFieldList: [],
    }
