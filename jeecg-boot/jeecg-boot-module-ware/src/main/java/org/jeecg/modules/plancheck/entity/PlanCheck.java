package org.jeecg.modules.plancheck.entity;
 ...
 */
@Data
@TableName("plan_check")
@ApiModel(value="plan_check对象", description="计划盘点")
public class PlanCheck implements Serializable {
    ...
    private java.math.BigDecimal packType;
	/**器材数量*/
