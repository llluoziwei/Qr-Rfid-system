package org.jeecg.modules.plrandomForm.entity;
 ...
 */
@Data
@TableName("plrandom_form")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="plrandom_form对象", description="随机盈亏表")
public class PlrandomForm implements Serializable {
