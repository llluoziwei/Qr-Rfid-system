  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/plrandomForm/plrandomForm/add",
          edit: "/plrandomForm/plrandomForm/edit",
          queryById: "/plrandomForm/plrandomForm/queryById"
        }
      }
    },
    computed: {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'depotBind','goodsBind','kitName','wareId','packType','wareNum','checkNum','profitLess','checkTime'))
        })
      },
      //渲染流程表单数据
      showFlowData(){
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'depotBind','goodsBind','kitName','wareId','packType','wareNum','checkNum','profitLess','checkTime'))
      },
    }
  }
</script>