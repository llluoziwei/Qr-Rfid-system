          ...
          <template v-if="toggleSearchStatus">
            ...
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="货架绑定">
                <j-search-select-tag placeholder="请选择货架绑定" v-model="queryParam.goodsBind" dict="ware_goods,goods_id,id"/>
              </a-form-item>
            </a-col>
  ...
  export default {
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'sel_search',value:'goodsBind',text:'货架绑定',dictTable:'ware_goods', dictText:'goods_id', dictCode:'id'})
