package org.jeecg.modules.kitcatalog2.entity;
 ...
 */
@Data
@TableName("kit_catalog2")
@ApiModel(value="kit_catalog2对象", description="器材目录2")
public class KitCatalog2 implements Serializable {
