package org.jeecg.modules.wareenter2.entity;
 ...
 */
@Data
@TableName("ware_enter2")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="ware_enter2对象", description="入库申请2")
public class WareEnter2 implements Serializable {
